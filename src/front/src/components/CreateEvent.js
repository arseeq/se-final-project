...
class CreateEvent extends Component {
    ...
    render() {
        let self = this;
        return (
            <AvForm id="eventCreate" style={{marginTop: "10px", marginBottom: "80px"}}>
                <Label for="name">Name of the Event <span>*</span></Label>
                <AvField name="name" id="name" onChange={this.handleChange} type="text"
                         required={true} value={this.state.name} errorMessage="Name of the event should be at least 1 character"
                         validate={{
                             required: {value: true},
                             minLength: {value: 1}
                         }}/>
                ...
                <AvField name="description" label="Description" id="description" onChange={this.handleChange} type="textarea"
